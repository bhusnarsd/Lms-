...
const getSingleChapter = catchAsync(async (req, res) => {
  const singleChapter = await chapterService.getChapterById(
...
const updateSingleClass = catchAsync(async (req, res) => {
  const updateddClass = await chapterService.updateChapterById(
    req.params.chapterId,
    req.body
  );
...
const deleteSingleChapter = catchAsync(async (req, res) => {
  const deletedChapter = await chapterService.deleteChapterById(
    req.params.chapterId
  );
